...
const MAIN_NAV = [
  ...
  { href: '/dashboard/security', label: 'Security & 2FA', labelKey: 'dash_security', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', feature: null },
  { href: '/dashboard/admin/email', label: 'Email & Notifications', labelKey: 'dash_email_admin', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', feature: 'email_composer', adminOnly: true },
  { href: '/dashboard/admin/rbac', label: 'Rôles & Permissions', labelKey: 'Rôles & Permissions', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', feature: 'email_composer', adminOnly: true },
  { href: '/dashboard/emailcomposer', label: 'Email Composer', labelKey: 'dash_email', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', feature: 'email_composer', adminOnly: true, superAdminOnly: true },
...
function SidebarContent({ user, logout }) {
  ...
  const visibleNav = MAIN_NAV.filter(item => {
    // superAdminOnly = réservé SUPER_ADMIN uniquement (Email Composer)
    if ((item as any).superAdminOnly && userCtx.role !== 'SUPER_ADMIN') return false;
