...
const MAIN_NAV = [
  ...
  { href: '/dashboard/projects',  label: 'Projets', labelKey: 'dash_projects',           icon: 'M3 3h18v4H3zm0 6h11v12H3zm13 6h6v6h-6z', feature: null },
  { href: '/dashboard/map',       label: 'Carte Afrique', labelKey: 'dash_map',     icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7', feature: 'africa_map' },
  ...
  { href: '/dashboard/mrv',       label: 'Calculateur MRV', labelKey: 'dash_mrv',   icon: 'M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18', feature: 'mrv_calculator' },
  { href: '/dashboard/assistant', label: 'Assistant IA', labelKey: 'dash_assistant',      icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z', feature: 'ai_assistant' },
  { href: '/dashboard/reports',   label: 'Rapports PDF', labelKey: 'dash_reports',      icon: 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8zM14 2v6h6M16 13H8m8 4H8m2-8H8', feature: 'pdf_reports' },
  { href: '/dashboard/marketplace', label: 'Marketplace', labelKey: 'dash_marketplace',       icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z', feature: 'carbon_marketplace' },
  ...
  { href: '/dashboard/notifications', label: 'Email Composer', labelKey: 'dash_email', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', feature: null },
