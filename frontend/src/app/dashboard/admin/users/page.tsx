              ...
              <tr key={u.id} style={{ borderBottom: '1px solid rgba(30,45,61,0.4)', transition: 'background 0.15s' }}
                ...
                <td style={{ padding: '10px 14px' }}>
                  <button onClick={() => updateUser(u.id, { isActive: !u.isActive })}
                    style={{ fontSize: 11, background: 'transparent', border: '1px solid #1E2D3D', borderRadius: 5, color: u.isActive ? '#F87171' : '#00FF94', padding: '4px 9px', cursor: 'pointer', whiteSpace: 'nowrap', transition: 'all 0.15s' }}>
