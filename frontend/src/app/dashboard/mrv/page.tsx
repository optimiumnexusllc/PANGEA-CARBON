...
const COUNTRIES = [
  { code:'CI', name:"Côte d'Ivoire", ef:0.547, currency:'XOF', flag:'🇨🇮' },
  { code:'GH', name:'Ghana',         ef:0.342, currency:'GHS', flag:'🇬🇭' },
  { code:'NG', name:'Nigeria',       ef:0.430, currency:'NGN', flag:'🇳🇬' },
  { code:'KE', name:'Kenya',         ef:0.251, currency:'KES', flag:'🇰🇪' },
  { code:'SN', name:'Sénégal',       ef:0.643, currency:'XOF', flag:'🇸🇳' },
  { code:'ZA', name:'Afrique du Sud',ef:0.928, currency:'ZAR', flag:'🇿🇦' },
  { code:'TZ', name:'Tanzanie',      ef:0.284, currency:'TZS', flag:'🇹🇿' },
  { code:'ET', name:'Éthiopie',      ef:0.027, currency:'ETB', flag:'🇪🇹' },
  { code:'RW', name:'Rwanda',        ef:0.158, currency:'RWF', flag:'🇷🇼' },
  { code:'CM', name:'Cameroun',      ef:0.210, currency:'XAF', flag:'🇨🇲' },
  { code:'MA', name:'Maroc',         ef:0.631, currency:'MAD', flag:'🇲🇦' },
  { code:'EG', name:'Égypte',        ef:0.527, currency:'EGP', flag:'🇪🇬' },
];
