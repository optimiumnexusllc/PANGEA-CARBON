...
const EMISSION_FACTORS = {
  ...
  // SCOPE 2 — Électricité (réseau national) — Source: IEA/UNFCCC/Verra 2024
  // AFRIQUE DE L'OUEST
  ...
  ELEC_ML:     { factor: 0.5980, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Mali' },
  ELEC_BF:     { factor: 0.6740, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Burkina Faso' },
  ELEC_TG:     { factor: 0.5710, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Togo' },
  ELEC_BJ:     { factor: 0.5190, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Bénin' },
  ELEC_NE:     { factor: 0.7120, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Niger' },
  ELEC_GN:     { factor: 0.2960, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Guinée' },
  ELEC_MR:     { factor: 0.5580, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Mauritanie' },
  ELEC_SL:     { factor: 0.2630, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Sierra Leone' },
  // AFRIQUE CENTRALE
  ELEC_CM:     { factor: 0.2090, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Cameroun' },
  ELEC_CD:     { factor: 0.0300, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — RD Congo' },
  ELEC_CG:     { factor: 0.2810, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Congo' },
  ELEC_GA:     { factor: 0.3420, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Gabon' },
  ELEC_TD:     { factor: 0.6240, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Tchad' },
  // AFRIQUE DE L'EST
  ELEC_KE:     { factor: 0.2510, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Kenya' },
  ELEC_TZ:     { factor: 0.3200, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Tanzanie' },
  ELEC_ET:     { factor: 0.1010, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Éthiopie' },
  ELEC_RW:     { factor: 0.3290, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Rwanda' },
  ELEC_UG:     { factor: 0.1910, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Ouganda' },
  ELEC_MZ:     { factor: 0.1190, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Mozambique' },
  ELEC_MG:     { factor: 0.5170, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Madagascar' },
  ELEC_ZW:     { factor: 0.5370, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Zimbabwe' },
  ELEC_MW:     { factor: 0.2780, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Malawi' },
  ELEC_SD:     { factor: 0.3520, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Soudan' },
  // AFRIQUE AUSTRALE
  ELEC_ZA:     { factor: 0.7970, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Afrique du Sud' },
  ELEC_ZM:     { factor: 0.2840, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Zambie' },
  ELEC_NA:     { factor: 0.3480, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Namibie' },
  ELEC_BW:     { factor: 1.0270, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Botswana' },
  ELEC_AO:     { factor: 0.3500, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Angola' },
  // AFRIQUE DU NORD
  ELEC_MA:     { factor: 0.6310, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Maroc' },
  ELEC_EG:     { factor: 0.5270, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Égypte' },
  ELEC_DZ:     { factor: 0.5620, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Algérie' },
  ELEC_TN:     { factor: 0.4900, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Tunisie' },
  // INTERNATIONAL
  ELEC_EUROPE: { factor: 0.2720, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Europe (moyenne)' },
  ELEC_WORLD:  { factor: 0.4940, unit: 'KWH', scope: 2, cat: 'ELECTRICITY', desc: 'Électricité — Mondiale (moyenne)' },
